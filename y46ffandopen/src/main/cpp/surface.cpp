 ...
 */JNIEXPORT jint JNICALL Java_com_demo_y46ffandopen_VideoSurface_setSurface(
	...
	jclass localVideoSurfaceClass = env->FindClass(
			"com/demo/y46ffandopen/VideoSurface");
 ...
 * Method:    onPause
 * Signature: ()I
 */JNIEXPORT jint JNICALL Java_com_demo_y46ffandopen_VideoSurface_nativePausePlayer(
		JNIEnv *, jobject) {
 ...
 * Method:    onResume
 * Signature: ()I
 */JNIEXPORT jint JNICALL Java_com_demo_y46ffandopen_VideoSurface_nativeResumePlayer(
		JNIEnv *, jobject) {
 ...
 * Method:    onDestroy
 * Signature: ()I
 */JNIEXPORT jint JNICALL Java_com_demo_y46ffandopen_VideoSurface_nativeStopPlayer(
		JNIEnv *, jobject) {
